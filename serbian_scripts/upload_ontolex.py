...
with open(f"profiles/serbian/config_private.json", 'r', encoding="utf-8") as jsonfile:
...
pos = {}
posraw = [{"lexinfopos":"https://serbian.wikibase.cloud/entity/Q23745","lexinfoposLabel":"Proper Noun","rdf":"http://www.lexinfo.net/ontology/2.0/lexinfo#ProperNoun"},{"lexinfopos":"https://serbian.wikibase.cloud/entity/Q23746","lexinfoposLabel":"Coordinating Conjunction","rdf":"http://www.lexinfo.net/ontology/2.0/lexinfo#coordinatingConjunction"},{"lexinfopos":"https://serbian.wikibase.cloud/entity/Q23747","lexinfoposLabel":"Subordinating Conjunction","rdf":"http://www.lexinfo.net/ontology/2.0/lexinfo#subordinatingConjunction"},{"lexinfopos":"https://serbian.wikibase.cloud/entity/Q23748","lexinfoposLabel":"Common Noun","rdf":"http://www.lexinfo.net/ontology/2.0/lexinfo#commonNoun"},{"lexinfopos":"https://serbian.wikibase.cloud/entity/Q23750","lexinfoposLabel":"Verb","rdf":"http://www.lexinfo.net/ontology/2.0/lexinfo#verb"},{"lexinfopos":"https://serbian.wikibase.cloud/entity/Q23751","lexinfoposLabel":"Adjective","rdf":"http://www.lexinfo.net/ontology/2.0/lexinfo#adjective"},{"lexinfopos":"https://serbian.wikibase.cloud/entity/Q23752","lexinfoposLabel":"Preposition","rdf":"http://www.lexinfo.net/ontology/2.0/lexinfo#preposition"},{"lexinfopos":"https://serbian.wikibase.cloud/entity/Q23753","lexinfoposLabel":"Adverb","rdf":"http://www.lexinfo.net/ontology/2.0/lexinfo#adverb"},{"lexinfopos":"https://serbian.wikibase.cloud/entity/Q23754","lexinfoposLabel":"Pronoun","rdf":"http://www.lexinfo.net/ontology/2.0/lexinfo#pronoun"},{"lexinfopos":"https://serbian.wikibase.cloud/entity/Q23756","lexinfoposLabel":"Number","rdf":"http://www.lexinfo.net/ontology/2.0/lexinfo#number"},{"lexinfopos":"https://serbian.wikibase.cloud/entity/Q23757","lexinfoposLabel":"Interjection","rdf":"http://www.lexinfo.net/ontology/2.0/lexinfo#interjection"}]
for entry in posraw:
    pos[entry['rdf']] = entry['lexinfopos'].replace('https://serbian.wikibase.cloud/entity/','')

# load existing lexemes lookup table
with open('profiles/serbian/data/lexeme_mapping.csv') as mappingcsv:
...
with open('profiles/serbian/data/ontolex_dict_lemma_forms.csv') as csvfile:
	rows = csv.DictReader(csvfile, delimiter=",") # "lexeme","lexinfoPos","oliaPos","lemma","forms"
	count = 0
	for row in rows:
		count += 1
		lexemeid = row['lexeme'].replace('http://llod.jerteh.rs/id/SMD/','') # SMD: Q2

		lexemepos = pos[row['lexinfoPos']]
		...
		# 			sys.exit()
		#
		# with open('profiles/serbian/data/lexeme_mapping.csv', 'a') as mappingcsv:
