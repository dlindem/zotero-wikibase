...
prop_wikidata_entity = config['mapping']['prop_wikidata_entity']  # externalId-prop for "Wikidata entity"
...
prop_instanceof = config['mapping']['prop_instance_of']  # datatype WikibaseItem, Wikidata P31
...
prop_formatterurl = config['mapping']['prop_formatterurl']  # datatype String, Wikidata P1630
prop_formatterurirdf = config['mapping']['prop_formatterurirdf']  # datatype String, Wikidata P1921
prop_inverseprop = config['mapping']['prop_inverseprop']  # datatype Property, Wikidata P1696
...
prop_wd_sitelinks = config['mapping']['prop_wd_sitelinks']  # datatype URL, for Wikipedia sitelinks from Wikidata
# essential ontology classes, to be defined here manually:
class_bibitem = config['mapping']['class_bibitem']  # bibliographical records
class_bibitem_type = config['mapping']['class_bibitem_type']  # bibliographical item type (journal article, book, etc.)
class_creator_role = config['mapping']['class_creator_role']  # creator role properties (e.g. author, translator)
class_journal = config['mapping']['class_journal']  # periodicals
class_language = config['mapping']['class_language']  # natural languages
class_ontology_class = config['mapping']['class_ontology_class']  # class that groups all ontology classes
class_organization = config['mapping']['class_organization']  # organizations (can be creators, publishers,...)
class_person = config['mapping']['class_person']  # natural persons (humans)
