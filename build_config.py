...
if config['mapping']['wikibase_url']:
    ...
    config['mapping']['mwclient_site'] = re.sub(r'https?://', '', wikibase_url)
    config['mapping']['wikibase_entity_ns'] = wikibase_url + "/entity/"
    config['mapping']['api_url'] = wikibase_url + "/w/api.php"
    config['mapping']['sparql_endpoint'] = wikibase_url + "/query/sparql"
